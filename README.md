# SecurityHeaders_GovUK
A scan of all .gov.uk sites for the most common security headers or lack of

In the interest of public safety, A scan for x-frame-options, strict-transport-security, content-security-policy, access-control-allow-origin, x-xss-protection, x-content-type-options
